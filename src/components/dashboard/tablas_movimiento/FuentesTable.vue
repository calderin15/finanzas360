<template>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr v-for="fuente in fuentes" :key="fuente.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-green-100 dark:hover:bg-gray-600">
...
export default {
    beforeMount() {
        ...
        axios.get('https://apigenerator.dronahq.com/api/O1JnK9a_/fuentes?id_user=' + usuario.id_user + "&_sort=id&_order=desc")
            .then(response => (
